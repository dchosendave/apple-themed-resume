/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: f49a3e44e89593a76fe3b859947dfaa7)
// Runtime types generated with workerd@1.20260903.1 2026-09-03 
interface __BaseEnv_Env {
	ASSETS: Fetcher;
	GITHUB_PULSE_API_URL: string;
	GITHUB_TOKEN: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "GITHUB_PULSE_API_URL" | "GITHUB_TOKEN">> {}
}
