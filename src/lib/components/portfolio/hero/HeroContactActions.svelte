<script lang="ts">
    ...
    import type { ContactPrompt } from "$lib/types/recruiter-prompt";
    ...
    let {
        ...
        showPrompt: (prompt: ContactPrompt) => void;
        clearPrompt: (prompt: ContactPrompt) => void;
    } = $props();
    ...
    const iconLinkClass = "size-11 sm:size-[34px]";
